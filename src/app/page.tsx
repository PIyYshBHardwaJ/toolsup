...
>
            ...
            <Link
               href="/tools/semester-grade-calculator"
               className="relative bg-white border border-gray-200 rounded-2xl p-7 hover:shadow-xl transition"
>
               <span className="absolute top-4 right-4 text-xs bg-black text-white px-3 py-1 rounded-full">
               Live
               ...
               <p className="text-sm text-gray-600">
                Calculate your semester GPA (SGPA) using subject-wise grades and credits.
                </p>
            </Link>

            <Link
               href="/tools/credit-based-cgpa-calculator"
               className="relative bg-white border border-gray-200 rounded-2xl p-7 hover:shadow-xl transition"
>
               <span className="absolute top-4 right-4 text-xs bg-black text-white px-3 py-1 rounded-full">
               Live
               ...
               <p className="text-sm text-gray-600">
                Calculate your overall CGPA using semester-wise SGPA and total credits.
                </p>
            </Link>

            <Link
               href="/tools/attendance-percentage-calculator"
               className="relative bg-white border border-gray-200 rounded-2xl p-7 hover:shadow-xl transition"
>
               <span className="absolute top-4 right-4 text-xs bg-black text-white px-3 py-1 rounded-full">
               Live
               ...
               <p className="text-sm text-gray-600">
                Calculate your attendance percentage using total classes conducted
                and classes attended. Simple and accurate for college students.
                </p>
            </Link>

            <Link
               href="/tools/required-attendance-calculator"
               className="relative bg-white border border-gray-200 rounded-2xl p-7 hover:shadow-xl transition"
>
               <span className="absolute top-4 right-4 text-xs bg-black text-white px-3 py-1 rounded-full">
               Live
               ...
               <p className="text-sm text-gray-600">
                Find out how many more classes you need to attend to reach the
                required attendance percentage set by your college.
                </p>
            </Link>
